...
const experiences = [
  {
    ...
    description: 'Liderando el desarrollo de aplicaciones web modernas con React y Node.js. Implementación de arquitecturas escalables y mejores prácticas.',
  ...
  },
  {
    ...
    location: 'Ciudad',
    period: '2022 - 2023',
    description: 'Desarrollo de soluciones e-commerce y aplicaciones web para diversos clientes. Colaboración directa con equipos de diseño y producto.',
  ...
  },
  {
    ...
    location: 'Ciudad',
    period: '2021 - 2022',
    description: 'Desarrollo de interfaces de usuario responsivas y accesibles. Implementación de diseños pixel-perfect y optimización de rendimiento.',
