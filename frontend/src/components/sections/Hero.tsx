...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary-50 via-white to-primary-100 dark:from-slate-900 dark:via-slate-900 dark:to-primary-950" />
      ...
      <div className="container-custom relative z-10 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="mt-6 text-xl md:text-2xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto text-balance"
          >
        ...
        >
          ...
          >
            <motion.div className="w-1.5 h-3 bg-slate-400 dark:bg-slate-600 rounded-full mt-2" />
          </motion.div>
        </motion.div>
      </div>
    </section>
