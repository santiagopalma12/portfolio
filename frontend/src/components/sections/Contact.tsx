          ...
          >
            ...
            <div className="mt-8 space-y-6">
              ...
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-white dark:bg-slate-800 hover:shadow-md transition-shadow group"
              >
                <div className="p-3 rounded-lg bg-primary-100 dark:bg-primary-900/30 text-primary-500 group-hover:bg-primary-500 group-hover:text-white transition-colors">
                ...
                <div>
                  ...
                  <div className="font-medium text-slate-900 dark:text-white">{SOCIAL_LINKS.email}</div>
                </div>
              </a>
