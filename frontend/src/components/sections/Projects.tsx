  ...
  return (
    <section id="projects" className="section-padding bg-slate-50 dark:bg-slate-800/50">
      <div className="container-custom">
                ...
                <CardContent className="flex-1 flex flex-col">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {project.technologies.slice(0, 4).map((tech) => (
                      <span
                        key={tech}
                        className="px-2.5 py-1 text-xs font-medium bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 rounded-full"
                      >
                        {tech}
                      </span>
                    ))}
        ...
        >
          <a
            href="https://github.com/santiago"
            target="_blank"
            rel="noopener noreferrer"
