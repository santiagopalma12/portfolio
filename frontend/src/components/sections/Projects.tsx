            ...
            >
              <Card hover className="group h-full flex flex-col">
                ...
                <CardContent className="flex-1 flex flex-col">
                  ...
                  {/* Links */}
                  <div className="mt-4 flex items-center justify-between gap-4 pt-4 border-t border-neutral-200 dark:border-neutral-800">
                    ...
                    {/* Ver más button */}
                    <Link
                      to={project.blogSlug ? `/project-blog/${project.blogSlug}` : `/project/${project.slug}`}
                      className="inline-flex items-center gap-1.5 text-sm font-medium px-3 py-1.5 bg-gradient-to-r from-purple-600 to-blue-500 text-white rounded-full hover:from-purple-700 hover:to-blue-600 transition-all shadow-sm hover:shadow-md"
                    >
                      Ver más
